...
def serve_many(
    ...
    *,
    ...
    """
    Creates an async handler that routes incoming requests to the correct workflow
    ...
    :return: An async handler that routes to the correct workflow
    """
    # Assign workflow IDs
    ...
    async def _router(request: TRequest) -> TResponse:
